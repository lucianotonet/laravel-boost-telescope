...
class TelescopeHttpClientTool extends TelescopeBoostTool
{
    protected string $name = 'telescope_http_client';

    public function description(): string
    {
        return 'Access HttpClient data from Laravel Telescope';
    }
