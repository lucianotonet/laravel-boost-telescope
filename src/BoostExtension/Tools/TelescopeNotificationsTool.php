...
class TelescopeNotificationsTool extends TelescopeBoostTool
{
    protected string $name = 'telescope_notifications';

    public function description(): string
    {
        return 'Access Notifications data from Laravel Telescope';
    }
